...
fun getStepSummaries(videoId: String): List<Pair<String, Int?>> {
    return when (videoId) {
        "_VqTaMZwj7I" -> listOf(
            "송탄부대찌개 소개 및 인트로 " to null,
            "양념장은 하루에서 이틀 정도 저온에서 숙성 권장" to null,
            "고춧가루, 후추, 다진마늘, 생강, 소금, 미원을 섞어 양념장을 만듭니다." to null,
            "양파는 길게 채썰고, 소시지는 어슷썰기로 썰어줍니다." to null,
        ...
        "gpt001" -> listOf(
            ...
            "요리 소개 및 주요 재료 설명" to null,
            "메인 재료 손질 및 소개" to null,
            "부재료(양파, 대파 등) 세척 및 썰기" to null,
            "고기/해산물 손질 및 준비" to null,
            "밑간 또는 재료 재우기 (소금, 간장, 맛술 등)" to null,
            "냄비/팬 예열 및 기름 두르기" to null,
            "양념 재료 (마늘, 생강 등) 볶기" to null,
            "주 재료(고기, 해산물 등) 볶기 또는 굽기" to 300,
            "김치/된장/고추장 등 기본 양념 추가" to null,
            "국물 재료(쌀뜨물, 물, 육수 등) 넣기" to null,
            "1차 끓이기 (5~10분)" to 600,
            "중간에 거품 제거 또는 간 조절" to null,
            "두부, 버섯, 채소 등 추가" to null,
            "양념 추가(소금, 간장, 고춧가루 등)" to null,
            "2차 끓이기 또는 졸이기 (10~30분)" to 1200,
            "불 조절 및 맛 점검" to null,
            "고명/마무리 재료(참기름, 깨 등) 넣기" to null,
            "그릇에 담기 및 플레이팅" to null,
            "시식 및 요리 완성 설명" to null,
            "마무리 인사 및 다음 영상 안내" to null
        )
    }
}
